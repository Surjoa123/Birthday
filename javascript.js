...
function reveal() {
  ...
  // ifrm.setAttribute("src", "img/video1.mp4");
...
button1.onclick = (function () {
    ...
    return function () {
        var currentContent = content[count % content.length];
        if (currentContent.type === "image") {
            root.style.setProperty("--image", "url(" + currentContent.src + ")");
            buttonText.textContent = phrases[count % phrases.length];
        } else if (currentContent.type === "video") {
            root.style.setProperty("--image", "none");
            buttonText.textContent = "Video Playing";
            var video = document.createElement("video");
            video.src = currentContent.src;
            video.autoplay = true;
            video.loop = true;
            video.controls = true;
            ...
            count = 0; // Reset count to start from the first image again
        }
        count++;
    };
})();
